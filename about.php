<?php 
include('path.php');
$app = new AddApp('About Us', 'StoreLad');
...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<!-- Page Title
		============================================= -->
		<section id="page-title" class="page-title-parallax page-title-dark" style="padding: 250px 0; background-image: url('<?php echo BASE_URL . '/assets'?>/images/about/parallax.jpg'); background-size: cover; background-position: center center;" data-bottom-top="background-position:0px 400px;" data-top-bottom="background-position:0px -500px;">
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="col_one_third">
                        <img src="<?php echo BASE_URL . '/assets'?>images/clients/7.png" alt="">
				...
				<div class="row align-items-stretch clearfix">
					...
					<div class="col-md-5 col-padding" style="background: url('<?php echo BASE_URL . '/assets'?>/images/team/3.jpg') center center no-repeat; background-size: cover;"></div>
				...
				<div class="row align-items-stretch bottommargin-lg clearfix">
					...
					<div class="col-md-5 col-padding" style="background: url('<?php echo BASE_URL . '/assets'?>/images/team/8.jpg') center center no-repeat; background-size: cover;"></div>
				...
				<div class="container clearfix">
					...
					<ul class="clients-grid grid-6 nobottommargin clearfix">
						<li><a href="http://logofury.com/logo/enzo.html"><img src="<?php echo BASE_URL . '/assets'?>/images/clients/1.png" alt="Clients"></a></li>
						<li><a href="http://logofury.com"><img src="<?php echo BASE_URL . '/assets'?>images/clients/2.png" alt="Clients"></a></li>
						<li><a href="http://logofaves.com/2014/03/grabbt/"><img src="<?php echo BASE_URL . '/assets'?>images/clients/3.png" alt="Clients"></a></li>
						<li><a href="http://logofaves.com/2014/01/ladera-granola/"><img src="<?php echo BASE_URL . '/assets'?>images/clients/4.png" alt="Clients"></a></li>
						<li><a href="http://logofaves.com/2014/02/hershel-farms/"><img src="<?php echo BASE_URL . '/assets'?>images/clients/5.png" alt="Clients"></a></li>
						<li><a href="http://logofury.com/logo/food-fight-radio.html"><img src="<?php echo BASE_URL . '/assets'?>images/clients/6.png" alt="Clients"></a></li>
						<li><a href="http://logofury.com"><img src="<?php echo BASE_URL . '/assets'?>images/clients/7.png" alt="Clients"></a></li>
						<li><a href="http://logofury.com/logo/up-travel.html"><img src="<?php echo BASE_URL . '/assets'?>images/clients/8.png" alt="Clients"></a></li>
						<li><a href="http://logofury.com/logo/caffi-bardi.html"><img src="<?php echo BASE_URL . '/assets'?>images/clients/9.png" alt="Clients"></a></li>
						<li><a href="http://logofury.com/logo/bignix-design.html"><img src="<?php echo BASE_URL . '/assets'?>images/clients/10.png" alt="Clients"></a></li>
						<li><a href="http://logofury.com/"><img src="<?php echo BASE_URL . '/assets'?>images/clients/11.png" alt="Clients"></a></li>
						<li><a href="http://logofury.com/"><img src="<?php echo BASE_URL . '/assets'?>images/clients/12.png" alt="Clients"></a></li>
					</ul>
