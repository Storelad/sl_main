...
$app->mode($_SERVER['HTTP_HOST']);

//$app->page = 'home';
?>
<!DOCTYPE html>
<html dir="ltr" lang="en-US">
<?php $app->includes('linkTop'); ?>
...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
			...
			<div class="slider-parallax-inner">
				...
				<div class="swiper-container swiper-parent">
					<div class="swiper-wrapper">
						<div class="swiper-slide dark" style="background-image: url('<?php echo BASE_URL . '/assets/images/cart-wheel.jpg'?>');">
						...
						<div class="swiper-slide dark">
							...
							<div class="video-wrap">
								<video id="slide-video" poster="<?php echo BASE_URL . '/assets/images/digtail.jpg'?>" preload="auto" loop autoplay muted>
									<!-- <source src='<?php echo BASE_URL . '/assets'?>/videos/explore.webm' type='video/webm' /> -->
									<source src='<?php echo BASE_URL . '/assets'?>/videos/video.mp4' type='video/mp4' />
								</video>
								<div class="video-overlay" style="background-color: rgba(0,0,0,0.55);"></div>
							</div>
						</div>
						<div class="swiper-slide dark" style="background-image: url('<?php echo BASE_URL . '/assets'?>/images/woman-bag.jpg'); background-position: center top;">
						<div class="video-overlay" style="background-color: rgba(0,0,0,0.55);"></div>
							<div class="container clearfix">
		...
		<section id="content">
			...
			<div class="content-wrap">
					...
					<div class="row clearfix">
						...
						<div class="col-xl-7">
							...
							<div style="position: relative; margin-bottom: -60px;" class="ohidden" data-height-xl="426" data-height-lg="567" data-height-md="470" data-height-md="287" data-height-xs="183">
								<img src="<?php echo BASE_URL . '/assets'?>/images/welcome-3.jpg" style="position: absolute; top: 0; left: 0;" data-animate="fadeInUp" data-delay="100" alt="Chrome">
								<!-- <img src="<?php echo BASE_URL . '/assets'?>/images/welcome-2.jpg" style="position: absolute; top: 0; left: 0;" data-animate="fadeInUp" data-delay="400" alt="iPad"> -->
							</div>
				...
				<div class="container clearfix">
					...
					<div class="row bottommargin-sm">
						...
						<div class="col-lg-4 d-md-none d-lg-block bottommargin center">
							<img src="<?php echo BASE_URL . '/assets'?>/images/phone.png" alt="iphone 2">
						</div>
				...
				<div class="row clearfix align-items-stretch">
					...
					<div class="col-lg-6 center col-padding" style="background: url('<?php echo BASE_URL . '/assets'?>/images/services/main-bg.jpg') center center no-repeat; background-size: cover;">
					</div>
					...
					<div class="col-lg-6 center col-padding" style="background-color: #F5F5F5;">
						...
						<div class="center bottommargin">
							<a href="http://vimeo.com/101373765" data-lightbox="iframe" style="position: relative;">
								<img src="<?php echo BASE_URL . '/assets'?>/images/services/video.jpg" alt="Video">
								<span class="i-overlay nobg"><img src="<?php echo BASE_URL . '/assets'?>/images/icons/video-play.png" alt="Play"></span>
							</a>
						</div>
				...
				<div id="portfolio" class="portfolio portfolio-nomargin grid-container portfolio-notitle portfolio-full grid-container clearfix">
					...
					<article class="portfolio-item pf-media pf-icons">
						<div class="portfolio-image">
							<a href="portfolio-single.html">
								<img src="<?php echo BASE_URL . '/assets'?>/images/portfolio/4/1.jpg" alt="Open Imagination">
							</a>
							<div class="portfolio-overlay">
								<a href="<?php echo BASE_URL . '/assets'?>/images/portfolio/full/1.jpg" class="left-icon" data-lightbox="<?php echo BASE_URL . '/assets'?>/image"><i class="icon-line-plus"></i></a>
					...
					<article class="portfolio-item pf-illustrations">
						<div class="portfolio-image">
							<a href="portfolio-single.html">
								<img src="<?php echo BASE_URL . '/assets'?>/images/portfolio/4/2.jpg" alt="Locked Steel Gate">
							</a>
							<div class="portfolio-overlay">
								<a href="<?php echo BASE_URL . '/assets'?>/images/portfolio/full/2.jpg" class="left-icon" data-lightbox="<?php echo BASE_URL . '/assets'?>/image"><i class="icon-line-plus"></i></a>
								<a href="portfolio-single.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
							</div>
						</div>
						<div class="portfolio-desc">
					...
					<article class="portfolio-item pf-graphics pf-uielements">
						<div class="portfolio-image">
							<a href="#">
								<img src="<?php echo BASE_URL . '/assets'?>/images/portfolio/4/3.jpg" alt="Mac Sunglasses">
							</a>
							<div class="portfolio-overlay">
					...
					<article class="portfolio-item pf-icons pf-illustrations">
						<div class="portfolio-image">
							<a href="portfolio-single.html">
								<img src="<?php echo BASE_URL . '/assets'?>/images/portfolio/4/4.jpg" alt="Open Imagination">
							</a>
							<div class="portfolio-overlay" data-lightbox="gallery">
								<a href="<?php echo BASE_URL . '/assets'?>/images/portfolio/full/4.jpg" class="left-icon" data-lightbox="gallery-item"><i class="icon-line-stack-2"></i></a>
								<a href="<?php echo BASE_URL . '/assets'?>/images/portfolio/full/4-1.jpg" class="hidden" data-lightbox="gallery-item"></a>
					...
					<article class="portfolio-item pf-uielements pf-media">
						<div class="portfolio-image">
							<a href="portfolio-single.html">
								<img src="<?php echo BASE_URL . '/assets'?>/images/portfolio/4/5.jpg" alt="Console Activity">
							</a>
							<div class="portfolio-overlay">
								<a href="<?php echo BASE_URL . '/assets'?>/images/portfolio/full/5.jpg" class="left-icon" data-lightbox="<?php echo BASE_URL . '/assets'?>/image"><i class="icon-line-plus"></i></a>
								<a href="portfolio-single.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
							</div>
						</div>
						<div class="portfolio-desc">
					...
					<article class="portfolio-item pf-graphics pf-illustrations">
						<div class="portfolio-image">
							<a href="portfolio-single.html">
								<img src="<?php echo BASE_URL . '/assets'?>/images/portfolio/4/6.jpg" alt="Open Imagination">
							</a>
							<div class="portfolio-overlay" data-lightbox="gallery">
								<a href="<?php echo BASE_URL . '/assets'?>/images/portfolio/full/6.jpg" class="left-icon" data-lightbox="gallery-item"><i class="icon-line-stack-2"></i></a>
								<a href="<?php echo BASE_URL . '/assets'?>/images/portfolio/full/6-1.jpg" class="hidden" data-lightbox="gallery-item"></a>
								<a href="<?php echo BASE_URL . '/assets'?>/images/portfolio/full/6-2.jpg" class="hidden" data-lightbox="gallery-item"></a>
								<a href="<?php echo BASE_URL . '/assets'?>/images/portfolio/full/6-3.jpg" class="hidden" data-lightbox="gallery-item"></a>
								<a href="portfolio-single-gallery.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
							</div>
						</div>
						<div class="portfolio-desc">
					...
					<article class="portfolio-item pf-uielements pf-icons">
						<div class="portfolio-image">
							<a href="portfolio-single-video.html">
								<img src="<?php echo BASE_URL . '/assets'?>/images/portfolio/4/7.jpg" alt="Backpack Contents">
							</a>
							<div class="portfolio-overlay">
					...
					<article class="portfolio-item pf-graphics">
						<div class="portfolio-image">
							<a href="portfolio-single.html">
								<img src="<?php echo BASE_URL . '/assets'?>/images/portfolio/4/8.jpg" alt="Sunset Bulb Glow">
							</a>
							<div class="portfolio-overlay">
								<a href="<?php echo BASE_URL . '/assets'?>/images/portfolio/full/8.jpg" class="left-icon" data-lightbox="<?php echo BASE_URL . '/assets'?>/image"><i class="icon-line-plus"></i></a>
								<a href="portfolio-single.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
							</div>
						</div>
						<div class="portfolio-desc">
				...
				<div class="container clearfix">
					...
					<div class="col_one_third bottommargin-sm center">
						<img data-animate="fadeInLeft" src="<?php echo BASE_URL . '/assets'?>/images/services/iphone6.png" alt="Iphone">
					</div>
				...
				<div class="section parallax dark nobottommargin" style="background-image: url('<?php echo BASE_URL . '/assets'?>/images/services/home-testi-bg.jpg'); padding: 100px 0;" data-bottom-top="background-position:0px 300px;" data-top-bottom="background-position:0px -300px;">
				...
				<div class="container clear-bottommargin clearfix">
					<div class="row">
						...
						<div class="col-lg-3 col-md-6 bottommargin">
							<div class="ipost clearfix">
								<div class="entry-image">
									<a href="#"><img class="<?php echo BASE_URL . '/assets'?>/image_fade" src="<?php echo BASE_URL . '/assets'?>/images/magazine/thumb/1.jpg" alt="<?php echo BASE_URL . '/assets'?>/image"></a>
								</div>
						...
						<div class="col-lg-3 col-md-6 bottommargin">
							<div class="ipost clearfix">
								<div class="entry-image">
									<a href="#"><img class="<?php echo BASE_URL . '/assets'?>/image_fade" src="<?php echo BASE_URL . '/assets'?>/images/magazine/thumb/2.jpg" alt="<?php echo BASE_URL . '/assets'?>/image"></a>
								</div>
								<div class="entry-title">
						...
						<div class="col-lg-3 col-md-6 bottommargin">
							<div class="ipost clearfix">
								<div class="entry-image">
									<a href="#"><img class="<?php echo BASE_URL . '/assets'?>/image_fade" src="<?php echo BASE_URL . '/assets'?>/images/magazine/thumb/3.jpg" alt="<?php echo BASE_URL . '/assets'?>/image"></a>
								</div>
								<div class="entry-title">
						...
						<div class="col-lg-3 col-md-6 bottommargin">
							<div class="ipost clearfix">
								<div class="entry-image">
									<a href="#"><img class="<?php echo BASE_URL . '/assets'?>/image_fade" src="<?php echo BASE_URL . '/assets'?>/images/magazine/thumb/4.jpg" alt="<?php echo BASE_URL . '/assets'?>/image"></a>
								</div>
								<div class="entry-title">
					...
					<div class="container clearfix">
						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-6 bottommargin">
								...
								<div class="team">
									<div class="team-image">
										<img src="<?php echo BASE_URL . '/assets'?>/images/team/2.jpg" alt="Josh Clark">
									</div>
									<div class="team-desc team-desc-bg">
							...
							<div class="col-lg-3 col-md-6 bottommargin">
								...
								<div class="team">
									<div class="team-image">
										<img src="<?php echo BASE_URL . '/assets'?>/images/team/8.jpg" alt="Mary Jane">
									</div>
									<div class="team-desc team-desc-bg">
							...
							<div class="col-lg-3 col-md-6 bottommargin">
								...
								<div class="team">
									<div class="team-image">
										<img src="<?php echo BASE_URL . '/assets'?>/images/team/4.jpg" alt="Nix Maxwell">
									</div>
									<div class="team-desc team-desc-bg">
				...
				<div class="container clearfix">
					...
					<div id="oc-clients" class="owl-carousel image-carousel carousel-widget" data-margin="60" data-loop="true" data-nav="false" data-autoplay="5000" data-pagi="false" data-items-xs="2" data-items-sm="3" data-items-md="4" data-items-lg="5" data-items-xl="6">
						...
						<div class="oc-item"><a href="#"><img src="<?php echo BASE_URL . '/assets'?>/images/clients/1.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="#"><img src="<?php echo BASE_URL . '/assets'?>/images/clients/2.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="#"><img src="<?php echo BASE_URL . '/assets'?>/images/clients/3.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="#"><img src="<?php echo BASE_URL . '/assets'?>/images/clients/4.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="#"><img src="<?php echo BASE_URL . '/assets'?>/images/clients/5.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="#"><img src="<?php echo BASE_URL . '/assets'?>/images/clients/6.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="#"><img src="<?php echo BASE_URL . '/assets'?>/images/clients/7.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="#"><img src="<?php echo BASE_URL . '/assets'?>/images/clients/8.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="#"><img src="<?php echo BASE_URL . '/assets'?>/images/clients/9.png" alt="Clients"></a></div>
						<div class="oc-item"><a href="#"><img src="<?php echo BASE_URL . '/assets'?>/images/clients/10.png" alt="Clients"></a></div>
		...
		<!-- Footer
		============================================= -->
        <?php $app->includes('footer'); ?>

	</div><!-- #wrapper end -->

    <?php $app->includes('linkBottom'); ?>
